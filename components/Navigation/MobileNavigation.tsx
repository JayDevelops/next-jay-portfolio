...
import {modalVariants, linkItemVariants, navLinksVariants} from "@/components/Navigation/MobileNavAnimate"
...
export function MobileNavigation({ closeMenu, isMobile }: MobileNavigationProps) {
