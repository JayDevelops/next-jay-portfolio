...
then go ahead and read this article where I talk about <Link href="/blog/prefix-sum">prefix sum!</Link> If you wish to continue, then go ahead but the following will be non-technical.
