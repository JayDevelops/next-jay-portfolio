...
After restarting Claude Desktop, you'll see the 🔌 icon indicating that MCP servers are connected. 
...
### Conclusion
Go ahead and clone the repo yourself over on <Link href="https://github.com/JayDevelops/poke-mcp" external>the poke-mcp repository</Link>.
